...
const fonte = readFileSync("pagina.html", "utf8") as string;
const css = readFileSync("pagina.css", "utf8") as string;
...
for (const sel of ["html", "body", "#content", ".mw-body", "#firstHeading",
                   "h1", "h2", "p", "a", "div", "table", "img"]) {
  relatar(sel);
}
