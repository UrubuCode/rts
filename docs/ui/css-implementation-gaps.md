...
| Transformações | `transform-origin`, e toda a família 3D (`perspective`, `transform-style`, `transform-box`, `translate3d`). | Transform 2D básico usa origem central; não existe matriz 3D nem profundidade de pintura. |
