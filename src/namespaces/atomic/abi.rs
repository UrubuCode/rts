...
pub const MEMBERS: &[NamespaceMember] = &[
    ...
    // ── AtomicF64 (backed by AtomicU64 via bit-transmute) ──────────
    NamespaceMember {
        name: "f64_new",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_ATOMIC_F64_NEW",
        args: &[AbiType::F64],
        returns: AbiType::Handle,
        doc: "Aloca um AtomicF64 inicializado com `value` e retorna o handle.",
        ts_signature: "f64_new(value: number): number",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "f64_load",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_ATOMIC_F64_LOAD",
        args: &[AbiType::U64],
        returns: AbiType::F64,
        doc: "Le o valor atual do AtomicF64 (SeqCst). 0.0 se handle invalido.",
        ts_signature: "f64_load(handle: number): number",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "f64_store",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_ATOMIC_F64_STORE",
        args: &[AbiType::U64, AbiType::F64],
        returns: AbiType::Void,
        doc: "Escreve `value` no AtomicF64 (SeqCst). No-op se handle invalido.",
        ts_signature: "f64_store(handle: number, value: number): void",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "f64_fetch_add",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_ATOMIC_F64_FETCH_ADD",
        args: &[AbiType::U64, AbiType::F64],
        returns: AbiType::F64,
        doc: "Soma `delta` e retorna o valor anterior (loop CAS internamente). 0.0 se handle invalido.",
        ts_signature: "f64_fetch_add(handle: number, delta: number): number",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "f64_swap",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_ATOMIC_F64_SWAP",
        args: &[AbiType::U64, AbiType::F64],
        returns: AbiType::F64,
        doc: "Troca o valor por `value` e retorna o valor anterior. 0.0 se handle invalido.",
        ts_signature: "f64_swap(handle: number, value: number): number",
        intrinsic: None,
        pure: false,
    },
    // ── Fences ─────────────────────────────────────────────────────
