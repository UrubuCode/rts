...
pub const MEMBERS: &[NamespaceMember] = &[
    ...
    // (#208) Predicate methods — sequenciais por preservacao de ordem.
    NamespaceMember {
        name: "filter",
        kind: MemberKind::Function,
        ...
        args: &[AbiType::Handle, AbiType::U64],
        returns: AbiType::Handle,
        doc: "Vec<i64> com elementos onde `fn_ptr(x) != 0`. `fn_ptr` e `extern \"C\" fn(i64) -> i64`.",
        ts_signature: "filter(vec_handle: number, fn_ptr: number): number",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "find",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_PARALLEL_FIND",
        args: &[AbiType::Handle, AbiType::U64],
        returns: AbiType::I64,
        doc: "Primeiro elemento que satisfaz predicate, ou 0.",
        ts_signature: "find(vec_handle: number, fn_ptr: number): number",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "find_index",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_PARALLEL_FIND_INDEX",
        args: &[AbiType::Handle, AbiType::U64],
        returns: AbiType::I64,
        doc: "Index do primeiro elemento que satisfaz predicate, ou -1.",
        ts_signature: "find_index(vec_handle: number, fn_ptr: number): number",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "some",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_PARALLEL_SOME",
        args: &[AbiType::Handle, AbiType::U64],
        returns: AbiType::Bool,
        doc: "True se algum elemento satisfaz predicate.",
        ts_signature: "some(vec_handle: number, fn_ptr: number): boolean",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        name: "every",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_PARALLEL_EVERY",
        args: &[AbiType::Handle, AbiType::U64],
        returns: AbiType::Bool,
        doc: "True se todos os elementos satisfazem predicate (true vacuosamente em vec vazio).",
        ts_signature: "every(vec_handle: number, fn_ptr: number): boolean",
        intrinsic: None,
        pure: false,
    },
];
