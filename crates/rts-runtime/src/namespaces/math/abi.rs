...
pub const MEMBERS: &[NamespaceMember] = &[
    ...
    NamespaceMember {
        name: "imul",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_MATH_IMUL",
        args: &[AbiType::I64, AbiType::I64],
        returns: AbiType::I64,
        doc: "C-style 32-bit signed multiplication (wrapping).",
        ts_signature: "imul(a: number, b: number): number",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
        name: "clz32",
        kind: MemberKind::Function,
        symbol: "__RTS_FN_NS_MATH_CLZ32",
        args: &[AbiType::I64],
        returns: AbiType::I64,
        doc: "Count leading zeros em uint32.",
        ts_signature: "clz32(x: number): number",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
