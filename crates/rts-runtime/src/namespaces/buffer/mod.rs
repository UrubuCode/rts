...
//! `docs/specs/rts-core-engine.md`). As fns `__RTS_FN_GL_*` (DataView,
//! ArrayBuffer, TypedArray view, Atomics) sao metodos de classes globais,
...
impl BufferNs {
    ...
    #[rts_fn]
    pub fn alloc_zeroed(size: I64) -> Handle {
    ...
    #[rts_fn]
    pub fn read_i32(handle: U64, offset: I64) -> I32 {
        with_buffer(handle, 0, |b| {
            if offset < 0 {
                return 0;
            }
    ...
    #[rts_fn]
    pub fn read_i64(handle: U64, offset: I64) -> I64 {
        with_buffer(handle, 0, |b| {
            if offset < 0 {
                return 0;
            }
    ...
    #[rts_fn]
    pub fn read_f64(handle: U64, offset: I64) -> F64 {
    ...
    #[rts_fn]
    pub fn read_f32(handle: U64, offset: I64) -> F64 {
        with_buffer(handle, f64::NAN, |b| {
            if offset < 0 {
                return f64::NAN;
            }
    ...
    #[rts_fn]
    pub fn write_u8(handle: U64, offset: I64, val: I32) {
    ...
    #[rts_fn]
    pub fn write_i32(handle: U64, offset: I64, val: I32) {
        with_buffer_mut(handle, (), |b| {
            if offset < 0 {
                return;
            }
    ...
    #[rts_fn]
    pub fn write_i64(handle: U64, offset: I64, val: I64) {
        with_buffer_mut(handle, (), |b| {
            if offset < 0 {
                return;
            }
    ...
    #[rts_fn]
    pub fn write_f64(handle: U64, offset: I64, val: F64) {
        with_buffer_mut(handle, (), |b| {
            if offset < 0 {
                return;
            }
    ...
    #[rts_fn(ts = "write_f32(handle: number, offset: number, val: number): void")]
    pub fn write_f32(handle: U64, offset: I64, val: F64) {
        with_buffer_mut(handle, (), |b| {
            if offset < 0 {
                return;
            }
    ...
    #[rts_fn(
        ts = "copy(dst: number, dstOff: number, src: number, srcOff: number, len: number): void"
    )]
    pub fn copy(dst: U64, dst_off: I64, src: U64, src_off: I64, len: I64) {
    ...
    #[rts_fn]
    pub fn fill(handle: U64, byte: I32, len: I64) {
        if len <= 0 {
            return;
        }
        with_buffer_mut(handle, (), |b| {
    ...
    #[rts_fn]
    pub fn to_string(handle: U64) -> Handle {
    ...
    #[rts_fn(pure)]
    pub fn index_of(handle: U64, byte: I32, from: I64) -> I64 {
