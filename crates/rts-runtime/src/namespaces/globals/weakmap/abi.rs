...
pub const MEMBERS: &[NamespaceMember] = &[
    ...
    NamespaceMember {
        ...
        returns: AbiType::Handle,
        doc: "Returns value for key (handle/string), or 0 if absent.",
    ...
    NamespaceMember {
        ...
        doc: "Returns true if key exists, false otherwise.",
    ...
    NamespaceMember {
        ...
        args: &[AbiType::Handle, AbiType::Handle],
        returns: AbiType::Bool,
        doc: "Removes key. Returns true if existed, false otherwise.",
