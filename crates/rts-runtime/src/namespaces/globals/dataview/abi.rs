...
pub const DATA_VIEW_MEMBERS: &[NamespaceMember] = &[
    ...
    NamespaceMember {
        ...
        args: &[AbiType::Handle, AbiType::I64, AbiType::I64, AbiType::I32],
        returns: AbiType::Void,
        doc: "setBigInt64(byteOffset, value, littleEndian).",
        ts_signature: "setBigInt64(byteOffset: number, value: bigint, littleEndian?: boolean): void",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        ...
        args: &[AbiType::Handle, AbiType::I64, AbiType::I32],
        returns: AbiType::I64,
        doc: "getBigInt64(byteOffset, littleEndian).",
        ts_signature: "getBigInt64(byteOffset: number, littleEndian?: boolean): bigint",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
        ...
        args: &[AbiType::Handle, AbiType::I64, AbiType::I64, AbiType::I32],
        returns: AbiType::Void,
        doc: "setBigUint64(byteOffset, value, littleEndian).",
        ts_signature: "setBigUint64(byteOffset: number, value: bigint, littleEndian?: boolean): void",
        intrinsic: None,
        pure: false,
    },
    NamespaceMember {
        ...
        args: &[AbiType::Handle, AbiType::I64, AbiType::I32],
        returns: AbiType::I64,
        doc: "getBigUint64(byteOffset, littleEndian).",
        ts_signature: "getBigUint64(byteOffset: number, littleEndian?: boolean): bigint",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
