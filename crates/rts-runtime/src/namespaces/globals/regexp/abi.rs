...
pub const MEMBERS: &[NamespaceMember] = &[
    ...
    NamespaceMember {
        ...
        args: &[AbiType::Handle],
        returns: AbiType::Handle,
        doc: "Returns the canonical flags string (e.g. 'gi').",
        ts_signature: "flags: string",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
        ...
        args: &[AbiType::Handle],
        returns: AbiType::Bool,
        doc: "Returns whether the 'g' flag is set.",
        ts_signature: "global: boolean",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
        ...
        args: &[AbiType::Handle],
        returns: AbiType::Bool,
        doc: "Returns whether the 'i' flag is set.",
        ts_signature: "ignoreCase: boolean",
        intrinsic: None,
        pure: true,
    },
    NamespaceMember {
    ...
    NamespaceMember {
        ...
        args: &[AbiType::Handle],
        returns: AbiType::Bool,
        doc: "Returns whether the 'm' flag is set.",
        ts_signature: "multiline: boolean",
        intrinsic: None,
        pure: true,
    },
];
