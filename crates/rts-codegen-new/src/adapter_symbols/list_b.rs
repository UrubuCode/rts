...
pub(super) fn symbols() -> Vec<JitSymbol> {
    let mut v: Vec<JitSymbol> = vec![
        ...
        sym(
            ...
            iterops::__rtsadp_for_in_keys as *const u8,
        ),
        sym("__rtsadp_iter_open", iterops::__rtsadp_iter_open as *const u8),
        sym("__rtsadp_iter_next", iterops::__rtsadp_iter_next as *const u8),
        sym(
            "__rtsadp_iter_close",
            iterops::__rtsadp_iter_close as *const u8,
        ),
        sym(
        ...
        sym("__rtsadp_seal", objops::__rtsadp_seal as *const u8),
        sym("__rtsadp_tsa_raw", iterops::__rtsadp_tsa_raw as *const u8),
        sym("__rtsadp_string_raw", iterops::__rtsadp_string_raw as *const u8),
        sym("__rtsadp_freeze", objops::__rtsadp_freeze as *const u8),
        sym("__rtsadp_is_frozen", objops::__rtsadp_is_frozen as *const u8),
        sym("__rtsadp_construct", ctorval::__rtsadp_construct as *const u8),
        sym("__rtsadp_is_sealed", objops::__rtsadp_is_sealed as *const u8),
        sym(
        ...
        sym(
            "__rtsadp_class_proto_init",
            crate::value::protos::__rtsadp_class_proto_init as *const u8,
        ),
        sym(
            "__rtsadp_class_proto_set",
            crate::value::protos::__rtsadp_class_proto_set as *const u8,
        ),
        sym(
        ...
        sym(
            "__rtsadp_instanceof_walk",
            crate::value::protos::__rtsadp_instanceof_walk as *const u8,
        ),
        sym(
        ...
        sym(
            ...
            dyndispatch::__rtsadp_dyn_ci_or_undef as *const u8,
        ),
        sym(
            "__rtsadp_dyn_p_then",
        ...
        sym(
            "__rtsadp_dyn_p_then2",
            dyndispatch::__rtsadp_dyn_p_then2 as *const u8,
        ),
        sym(
            "__rtsadp_dyn_p_catch",
            dyndispatch::__rtsadp_dyn_p_catch as *const u8,
        ),
        sym(
            "__rtsadp_dyn_p_finally",
            dyndispatch::__rtsadp_dyn_p_finally as *const u8,
        ),
        sym(
            "__rtsadp_idx_call",
