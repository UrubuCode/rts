...
pub fn sig_of(name: &str) -> Option<SymSig> {
    ...
    Some(match name {
        ...
        "__rtsadp_typeof" | "__rtsadp_to_string" | "__rtsadp_to_boolean" => SymSig {
            params: &[U64],
            ret: U64,
        },
        ...
        "__rtsadp_is_prototype_of" | "__rtsadp_has_own" | "__rtsadp_obj_set_proto" => SymSig {
            params: &[U64, U64],
            ret: U64,
        },
