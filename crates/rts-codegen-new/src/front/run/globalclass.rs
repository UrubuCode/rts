...
impl<'a, 'b, 'c> Lowerer<'a, 'b, 'c> {
    ...
    // `global_instance_class` (static receiver-class inference) lives in the
    // sibling `globalclass_receiver` module — one cohesive responsibility, split
    // out to keep this file under the size floor.
