...
| O | selectores que faltam | 3 | ◐ em curso | `feat/dom-lote-o-selectores` | §5.O |
| P | at-rules | 3 | ◐ em curso — outro agente | — | §5.P |
| Q | CSSOM | 3 | ☐ | — | §5.Q |
| R | grid e flex completos | 3 | ◐ em curso — outro agente | — | §5.R |
| S | propriedades parseadas sem efeito | 3 | ◐ em curso — outro agente | — | §5.S |
| T | fontes reais | 3 | ☐ | — | §5.T |
| U | composição e pintura | 3 | ☐ | — | §5.U |
