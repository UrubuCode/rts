...
pub(in crate::layout) fn place_anchored_floats(
    ...
    for (node, caixa) in anchors {
        ...
        let size = super::float_placement::measure_float(dom, tree, node, caixa, content_w, None, parent_css, font_size, ctx);
        ...
        super::float_placement::place_float(dom, node, caixa, side, size, top, x, content_w, None, bfc, ctx, list);
    }
}
