...
//! pelo seu próprio container — `crate::layout::flex::column_rtl::cross_x` faz exatamente esta
...
//! BLOCO): a MESMA guarda de `writing-mode` que `crate::layout::flex::column_rtl::cross_x` tem —
