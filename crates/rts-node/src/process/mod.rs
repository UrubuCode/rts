...
pub fn register(e: &mut Engine) {
    e.ns("node:process")
        ...
        .member(func(
            ...
            __RTS_FN_NODE_PROCESS_PLATFORM as *const u8,
        ))
        .member(func(
            "arch",
            ...
            __RTS_FN_NODE_PROCESS_ARCH as *const u8,
        ))
        .member(func(
            "pid",
            ...
            __RTS_FN_NODE_PROCESS_PID as *const u8,
        ))
        .member(func(
            "cwd",
            ...
            __RTS_FN_NODE_PROCESS_CWD as *const u8,
        ))
        .member(func(
            "chdir",
            ...
            __RTS_FN_NODE_PROCESS_CHDIR as *const u8,
        ))
        .member(func(
            "exit",
            ...
            __RTS_FN_NODE_PROCESS_EXIT as *const u8,
        ))
        .done();
}
