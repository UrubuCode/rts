...
//! encodings, shapes and ABI inside `rts-cranelift`/`rts-core` — none of
...
//! `rts-core/src/entry/modules.rs` (the only value API this module may
//! use) exposes no symbol constructor — only `rts-core`'s own
