...
#[rtse::function(module = "atomic", value = "i64_new", ret_ts = "number")]
fn i64_new(value: I64) -> Handle {
...
fn i64_store(handle: U64, value: I64) {
...
fn i64_fetch_add(handle: U64, delta: I64) -> I64 {
...
fn i64_fetch_sub(handle: U64, delta: I64) -> I64 {
...
fn i64_fetch_and(handle: U64, mask: I64) -> I64 {
...
fn i64_fetch_or(handle: U64, mask: I64) -> I64 {
...
fn i64_fetch_xor(handle: U64, mask: I64) -> I64 {
...
fn i64_swap(handle: U64, value: I64) -> I64 {
...
fn i64_cas(handle: U64, expected: I64, new_value: I64) -> I64 {
...
#[rtse::function(module = "atomic", value = "bool_new", ret_ts = "number")]
fn bool_new(value: Bool) -> Handle {
...
fn bool_store(handle: U64, value: Bool) {
...
fn bool_swap(handle: U64, value: Bool) -> Bool {
...
#[rtse::function(module = "atomic", value = "f64_new", ret_ts = "number")]
fn f64_new(value: F64) -> Handle {
...
fn f64_store(handle: U64, value: F64) {
...
fn f64_fetch_add(handle: U64, delta: F64) -> F64 {
...
fn f64_swap(handle: U64, value: F64) -> F64 {
    with_atomic_f64(handle, 0.0, |a| {
