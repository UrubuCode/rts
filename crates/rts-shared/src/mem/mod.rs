...
#[rtse::abi("__RTS_FN_NS_MEM_SIZE_OF_I64")]
pub fn __RTS_FN_NS_MEM_SIZE_OF_I64() -> I64 {
    std::mem::size_of::<i64>() as i64
}

/// Tamanho em bytes de um f64 (= 8).
#[rtse::abi("__RTS_FN_NS_MEM_SIZE_OF_F64")]
pub fn __RTS_FN_NS_MEM_SIZE_OF_F64() -> I64 {
    std::mem::size_of::<f64>() as i64
}

/// Tamanho em bytes de um i32 (= 4).
#[rtse::abi("__RTS_FN_NS_MEM_SIZE_OF_I32")]
pub fn __RTS_FN_NS_MEM_SIZE_OF_I32() -> I64 {
    std::mem::size_of::<i32>() as i64
}

/// Tamanho em bytes de um bool (= 1).
#[rtse::abi("__RTS_FN_NS_MEM_SIZE_OF_BOOL")]
pub fn __RTS_FN_NS_MEM_SIZE_OF_BOOL() -> I64 {
    std::mem::size_of::<bool>() as i64
}

/// Alinhamento de i64 (= 8).
#[rtse::abi("__RTS_FN_NS_MEM_ALIGN_OF_I64")]
pub fn __RTS_FN_NS_MEM_ALIGN_OF_I64() -> I64 {
    std::mem::align_of::<i64>() as i64
}

/// Alinhamento de f64 (= 8).
#[rtse::abi("__RTS_FN_NS_MEM_ALIGN_OF_F64")]
pub fn __RTS_FN_NS_MEM_ALIGN_OF_F64() -> I64 {
    std::mem::align_of::<f64>() as i64
}

/// Retorna `b` (use idiom: `let old = mem.swap_i64(a, b)`).
#[rtse::abi("__RTS_FN_NS_MEM_SWAP_I64")]
pub fn __RTS_FN_NS_MEM_SWAP_I64(_a: I64, b: I64) -> I64 {
...
#[rtse::abi("__RTS_FN_NS_MEM_DROP_HANDLE")]
pub fn __RTS_FN_NS_MEM_DROP_HANDLE(h: Handle) {
    let _ = rts_engine::heap::handles::free_handle(h);
}

/// Esquece handle sem rodar drop — vaza memoria intencionalmente.
#[rtse::abi("__RTS_FN_NS_MEM_FORGET_HANDLE")]
pub fn __RTS_FN_NS_MEM_FORGET_HANDLE(_h: Handle) {
    // Intencional: nao chama free.
}

/// Idiom: `mem.replace_i64(slot, new)` — retorna slot e usa caller pra escrever.
#[rtse::abi("__RTS_FN_NS_MEM_REPLACE_I64")]
pub fn __RTS_FN_NS_MEM_REPLACE_I64(slot: I64, _new_val: I64) -> I64 {
    slot
}
