...
/// `protobuf.newWriter()`.
#[rtse::abi("__RTS_FN_NS_PROTOBUF_NEW_WRITER")]
pub fn __RTS_FN_NS_PROTOBUF_NEW_WRITER() -> u64 {
    build_writer()
}

/// `protobuf.newReader(data)`.
#[rtse::abi("__RTS_FN_NS_PROTOBUF_NEW_READER")]
pub fn __RTS_FN_NS_PROTOBUF_NEW_READER(data: u64) -> u64 {
    build_reader(&read_bytes(data))
}

/// `protobuf.encodeVarint(value)` → standalone byte array (no writer needed).
#[rtse::abi("__RTS_FN_NS_PROTOBUF_ENCODE_VARINT")]
pub fn __RTS_FN_NS_PROTOBUF_ENCODE_VARINT(value: i64) -> u64 {
    let mut out = Vec::new();
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_DECODE_VARINT")]
pub fn __RTS_FN_NS_PROTOBUF_DECODE_VARINT(data: u64, offset: i64) -> u64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WT_VARINT")]
pub fn __RTS_FN_NS_PROTOBUF_WT_VARINT() -> i64 {
    WireType::Varint as i64
}
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WT_I64")]
pub fn __RTS_FN_NS_PROTOBUF_WT_I64() -> i64 {
    WireType::I64 as i64
}
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WT_LEN")]
pub fn __RTS_FN_NS_PROTOBUF_WT_LEN() -> i64 {
    WireType::Len as i64
}
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WT_I32")]
pub fn __RTS_FN_NS_PROTOBUF_WT_I32() -> i64 {
    WireType::I32 as i64
}
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_TAG")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_TAG(this: u64, field_number: i64, wire_type: i64) -> u64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_VARINT")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_VARINT(this: u64, value: i64) -> u64 {
    let mut out = Vec::new();
    wire::write_varint(&mut out, value as u64);
    writer_append(this, &out);
    this
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_ZIGZAG")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_ZIGZAG(this: u64, value: i64) -> u64 {
    let mut out = Vec::new();
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_FIXED32")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_FIXED32(this: u64, value: i64) -> u64 {
    let mut out = Vec::new();
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_FIXED64")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_FIXED64(this: u64, value: i64) -> u64 {
    let mut out = Vec::new();
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_BYTES")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_BYTES(this: u64, data: u64) -> u64 {
    let mut out = Vec::new();
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_WRITER_FINISH")]
pub fn __RTS_FN_NS_PROTOBUF_WRITER_FINISH(this: u64) -> u64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_TAG")]
pub fn __RTS_FN_NS_PROTOBUF_READER_TAG(this: u64) -> i64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_FIELD_NUM")]
pub fn __RTS_FN_NS_PROTOBUF_READER_FIELD_NUM(this: u64) -> i64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_VARINT")]
pub fn __RTS_FN_NS_PROTOBUF_READER_VARINT(this: u64) -> i64 {
    let Some((buf, pos)) = reader_state(this) else { return -1 };
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_ZIGZAG")]
pub fn __RTS_FN_NS_PROTOBUF_READER_ZIGZAG(this: u64) -> i64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_FIXED32")]
pub fn __RTS_FN_NS_PROTOBUF_READER_FIXED32(this: u64) -> i64 {
    let Some((buf, pos)) = reader_state(this) else { return 0 };
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_FIXED64")]
pub fn __RTS_FN_NS_PROTOBUF_READER_FIXED64(this: u64) -> i64 {
    let Some((buf, pos)) = reader_state(this) else { return 0 };
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_BYTES")]
pub fn __RTS_FN_NS_PROTOBUF_READER_BYTES(this: u64) -> u64 {
...
#[rtse::abi("__RTS_FN_NS_PROTOBUF_READER_SKIP")]
pub fn __RTS_FN_NS_PROTOBUF_READER_SKIP(this: u64) -> i64 {
