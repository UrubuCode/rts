...
//! (rumo à remoção da `rts-macro`; ver pilotos hint/hash/ptr/mem/runtime). A fn
//! extern nao-membro que sobra (PARSE5) eh chamada direto pelo codegen por
//! simbolo e fica como free fn abaixo.
