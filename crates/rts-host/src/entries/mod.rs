...
pub(crate) fn resolve(op: RuntimeOp) -> (CoreEntry, *const u8) {
    ...
    match op {
        ...
        RuntimeOp::SerdeDeclare => (CoreEntry::SerdeDeclare, {
            rts_core::entry::serde_declare as extern "C" fn(u64, i64, i64, i64) -> u64 as *const u8
        }),
        ...
        RuntimeOp::IteratorResult => (CoreEntry::IteratorResult, {
            rts_core::entry::iterator_result as extern "C" fn(u64) -> u64 as *const u8
        }),
        ...
        RuntimeOp::ArrayPatternDirect => (CoreEntry::ArrayPatternDirect, {
            rts_core::entry::array_pattern_direct as extern "C" fn(u64) -> u64 as *const u8
        }),
