...
//! [`rts_core_rwk::entry::make_prototype`] happily hands back by name. This
...
/// same shape `events::make_emitter`/`stream::common::init_emitter` build,
/// duplicated for the reason this file's own doc gives.
