//! Values, handles and scopes as an addon meets them.
//!
//! Public vocabulary only — see the crate's lib.rs for why the tests live
//! here rather than beside the code.

mod common;

use common::in_a_program;
use rts_napi_rwk::abi::NAPI_AUTO_LENGTH;
use rts_napi_rwk::{Env, env, handles, napi_status, napi_valuetype, values};
