...
use rts_napi_rwk::class::{napi_property_attributes, napi_property_descriptor};
use rts_napi_rwk::{Env, class, env, functions, handles, napi_status, objects, values};
...
fn a_static_member_lands_on_the_constructor_and_not_on_the_instance() {
    ...
    in_a_program(|| {
        ...
        assert_eq!(
            kind,
            rts_napi_rwk::napi_valuetype::napi_undefined,
