...
//! `crates/rts-core/README.md` — todo nativo que chama código de usuário
...
//! errado. Esse é o dia de expor a fábrica, e é um pedido ao `rts-core` do
...
///
/// # Reuse-check: o mais próximo é `rts_core::value::to_int32`, e não serve
///
