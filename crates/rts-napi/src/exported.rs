...
exported! {
    ...
    bigints::napi_create_bigint_int64,
    bigints::napi_create_bigint_uint64,
    bigints::napi_create_bigint_words,
    bigints::napi_get_value_bigint_int64,
    bigints::napi_get_value_bigint_uint64,
    bigints::napi_get_value_bigint_words,
    cleanup::napi_add_async_cleanup_hook,
    cleanup::napi_remove_async_cleanup_hook,
    dates::napi_create_date,
    dates::napi_get_date_value,
    dates::napi_is_date,
    finalizers::napi_add_finalizer,
    instance::napi_get_instance_data,
    instance::napi_set_instance_data,
    integrity::napi_get_all_property_names,
    integrity::napi_object_freeze,
    integrity::napi_object_seal,
    tags::napi_check_object_type_tag,
    tags::napi_type_tag_object,
    ...
    buffers::napi_detach_arraybuffer,
    buffers::napi_is_detached_arraybuffer,
    ...
    convert::napi_coerce_to_bool,
    convert::napi_coerce_to_number,
    convert::napi_coerce_to_string,
    convert::napi_create_int64,
    convert::napi_create_uint32,
    convert::napi_get_global,
    convert::napi_get_value_int32,
    convert::napi_get_value_int64,
    convert::napi_get_value_uint32,
    convert::napi_strict_equals,
    ...
    rest::napi_add_env_cleanup_hook,
    rest::napi_adjust_external_memory,
    rest::napi_async_destroy,
    rest::napi_async_init,
    rest::napi_cancel_async_work,
    rest::napi_coerce_to_object,
    rest::napi_create_dataview,
    rest::napi_create_external_arraybuffer,
    rest::napi_create_external_buffer,
    rest::napi_create_promise,
    rest::napi_create_string_latin1,
    rest::napi_create_string_utf16,
    rest::napi_create_symbol,
    rest::napi_create_typedarray,
    rest::napi_delete_element,
    rest::napi_fatal_error,
    rest::napi_fatal_exception,
    rest::napi_get_arraybuffer_info,
    rest::napi_get_dataview_info,
    rest::napi_get_last_error_info,
    rest::napi_get_new_target,
    rest::napi_get_node_version,
    rest::napi_get_prototype,
    rest::napi_get_uv_event_loop,
    rest::napi_get_value_string_latin1,
    rest::napi_get_value_string_utf16,
    rest::napi_get_version,
    rest::napi_has_element,
    rest::napi_has_named_property,
    rest::napi_has_own_property,
    rest::napi_is_arraybuffer,
    rest::napi_is_dataview,
    rest::napi_is_promise,
    rest::napi_make_callback,
    rest::napi_reject_deferred,
    rest::napi_remove_env_cleanup_hook,
    rest::napi_resolve_deferred,
    rest::napi_run_script,
    scopes::napi_close_callback_scope,
    scopes::napi_close_escapable_handle_scope,
    scopes::napi_close_handle_scope,
    scopes::napi_escape_handle,
    scopes::napi_open_callback_scope,
    scopes::napi_open_escapable_handle_scope,
    scopes::napi_open_handle_scope,
