...
pub(crate) fn resolve(op: RuntimeOp) -> (CoreEntry, *const u8) {
    ...
    match op {
        ...
        RuntimeOp::GeneratorNew => (CoreEntry::GeneratorNew, {
            rts_core_rwk::entry::generator_new
        ...
        RuntimeOp::Thrown => (CoreEntry::Thrown, {
            rts_core_rwk::entry::thrown as extern "C" fn() -> i64 as *const u8
        }),
        RuntimeOp::TakeThrown => (CoreEntry::TakeThrown, {
            rts_core_rwk::entry::take_thrown as extern "C" fn() -> u64 as *const u8
        }),
        RuntimeOp::RunningFunction => (CoreEntry::RunningFunction, {
            rts_core_rwk::entry::running_function as extern "C" fn() -> u64 as *const u8
        }),
        ...
        RuntimeOp::ModulePublish => (CoreEntry::ModulePublish, {
            rts_core_rwk::entry::module_publish as extern "C" fn(i64, i64, u64) -> u64 as *const u8
        }),
        ...
        RuntimeOp::SuperConstructWithArgs => (CoreEntry::SuperConstructWithArgs, {
            rts_core_rwk::entry::super_construct_with_args
