...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-35.5%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 35.5%   210/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **35.5%** (210/592) |
| ✅ RTS = Bun = Node | 210 |
| ❌ RTS diverge | 74 |
| 💥 RTS runtime error | 308 |
| 🛠️  **Falta corrigir** | **382** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-27 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
