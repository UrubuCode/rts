...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-98.1%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 98.1%   365/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **98.1%** (365/372) |
| ✅ RTS = Bun = Node | 365 |
| ❌ RTS diverge | 3 |
| 💥 RTS runtime error | 4 |
| 🛠️  **Falta corrigir** | **7** |
