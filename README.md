...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-76.6%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 76.6%   285/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **76.6%** (285/372) |
| ✅ RTS = Bun = Node | 285 |
| ❌ RTS diverge | 28 |
