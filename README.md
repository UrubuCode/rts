...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-83.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 83.1%   309/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **83.1%** (309/372) |
| ✅ RTS = Bun = Node | 309 |
| ❌ RTS diverge | 19 |
| 💥 RTS runtime error | 44 |
| 🛠️  **Falta corrigir** | **63** |
| ⚠️ Bun ≠ Node (skip) | 16 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 388 |

_Atualizado: 2026-05-27 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
