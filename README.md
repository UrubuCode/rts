...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-72.7%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 72.7%   224/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **72.7%** (224/308) |
| ✅ RTS = Bun = Node | 224 |
| ❌ RTS diverge | 29 |
