...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.6%25-yellowgreen?style=flat-square)](the spec removed 2026-08-03 (see git history))
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 82.6%   1252/1515 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **82.6%** (1252/1515) |
| ✅ RTS = Bun = Node | 1252 |
| ❌ RTS diverges | 202 |
...
_Updated: 2026-09-14 — [how to add a fixture](the spec removed 2026-08-03 (see git history))_
...
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 69.1%   601/870 WPT reftests (css-flexbox) rendering test == reference
```
...
*Updated 2026-09-12 by CI (`dom-rulers`).*
<!-- CSS_DOM_STATS_END -->
...
End-to-end process time (includes startup/JIT compile), median of 20 runs after 3 warmups, GitHub Actions `windows-latest` — commit `120d13e`.

| Bench | Bun | Node | Deno | RTS JIT | **RTS AOT** | AOT vs Bun | AOT vs Node |
|---|---|---|---|---|---|---:|---:|

_Updated: 2026-09-14 — run locally with `powershell -File bench/benchmark.ps1`_
