...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.1%25-yellowgreen?style=flat-square)](the spec removed 2026-08-03 (see git history))
...
JS spec compatibility validated against **Bun** and **Node** over 1196 standalone TS fixtures.

```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 82.1%   981/1195 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **82.1%** (981/1195) |
| ✅ RTS = Bun = Node | 981 |
| ❌ RTS diverges | 146 |
