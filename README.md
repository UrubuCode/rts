...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-23.4%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 23.4%   138/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **23.4%** (138/591) |
| ✅ RTS = Bun = Node | 138 |
| ❌ RTS diverge | 35 |
| 💥 RTS runtime error | 418 |
