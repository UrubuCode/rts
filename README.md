...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-78.5%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 78.5%   292/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **78.5%** (292/372) |
| ✅ RTS = Bun = Node | 292 |
| ❌ RTS diverge | 23 |
