...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-36.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 36.6%   113/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **36.6%** (113/309) |
| ✅ RTS = Bun = Node | 113 |
| ❌ RTS diverge | 76 |
| 💥 RTS runtime error | 120 |
| 🛠️  **Falta corrigir** | **196** |
| ⚠️ Bun ≠ Node (skip) | 3 |
