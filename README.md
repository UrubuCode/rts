...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-99.5%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 99.5%   370/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **99.5%** (370/372) |
| ✅ RTS = Bun = Node | 370 |
| ❌ RTS diverge | 0 |
| 💥 RTS runtime error | 2 |
| 🛠️  **Falta corrigir** | **2** |
