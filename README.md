...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-60.7%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱] 60.7%   187/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **60.7%** (187/308) |
| ✅ RTS = Bun = Node | 187 |
| ❌ RTS diverge | 46 |
| 💥 RTS runtime error | 75 |
| 🛠️  **Falta corrigir** | **121** |
| ⚠️ Bun ≠ Node (skip) | 4 |
