...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.7%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.7%   304/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.7%** (304/372) |
| ✅ RTS = Bun = Node | 304 |
| ❌ RTS diverge | 18 |
| 💥 RTS runtime error | 50 |
| 🛠️  **Falta corrigir** | **68** |
| ⚠️ Bun ≠ Node (skip) | 16 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 388 |

_Atualizado: 2026-05-26 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
