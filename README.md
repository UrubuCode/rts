...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-36.9%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 36.9%   114/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **36.9%** (114/309) |
| ✅ RTS = Bun = Node | 114 |
| ❌ RTS diverge | 75 |
| 💥 RTS runtime error | 120 |
| 🛠️  **Falta corrigir** | **195** |
| ⚠️ Bun ≠ Node (skip) | 3 |
