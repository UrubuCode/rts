...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-97.3%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 97.3%   362/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **97.3%** (362/372) |
| ✅ RTS = Bun = Node | 362 |
| ❌ RTS diverge | 3 |
| 💥 RTS runtime error | 7 |
| 🛠️  **Falta corrigir** | **10** |
