...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-87.1%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 87.1%   324/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **87.1%** (324/372) |
| ✅ RTS = Bun = Node | 324 |
| ❌ RTS diverge | 12 |
