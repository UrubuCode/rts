...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.6%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.6%   252/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.6%** (252/309) |
| ✅ RTS = Bun = Node | 252 |
| ❌ RTS diverge | 20 |
