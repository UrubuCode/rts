...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-43.1%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 43.1%   255/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **43.1%** (255/592) |
| ✅ RTS = Bun = Node | 255 |
| ❌ RTS diverge | 133 |
| 💥 RTS runtime error | 204 |
| 🛠️  **Falta corrigir** | **337** |
| ⚠️ Bun ≠ Node (skip) | 17 |
