...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-88.7%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 88.7%   329/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **88.7%** (329/371) |
| ✅ RTS = Bun = Node | 329 |
| ❌ RTS diverge | 6 |
