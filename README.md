...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-50.5%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 50.5%   156/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **50.5%** (156/309) |
| ✅ RTS = Bun = Node | 156 |
| ❌ RTS diverge | 52 |
