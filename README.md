...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-28.6%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 28.6%   169/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **28.6%** (169/591) |
| ✅ RTS = Bun = Node | 169 |
| ❌ RTS diverge | 46 |
| 💥 RTS runtime error | 376 |
| 🛠️  **Falta corrigir** | **422** |
| ⚠️ Bun ≠ Node (skip) | 18 |
