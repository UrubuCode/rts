...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-87.6%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 87.6%   326/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **87.6%** (326/372) |
| ✅ RTS = Bun = Node | 326 |
| ❌ RTS diverge | 10 |
...
_Atualizado: 2026-05-30 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
