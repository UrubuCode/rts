...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-51.5%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 51.5%   159/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **51.5%** (159/309) |
| ✅ RTS = Bun = Node | 159 |
| ❌ RTS diverge | 49 |
