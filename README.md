...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.9%   425/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **71.9%** (425/591) |
| ✅ RTS = Bun = Node | 425 |
| ❌ RTS diverge | 126 |
| 💥 RTS runtime error | 40 |
| 🛠️  **Falta corrigir** | **166** |
| ⚠️ Bun ≠ Node (skip) | 18 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-08 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
