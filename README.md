...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-21.3%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 21.3%   126/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **21.3%** (126/592) |
| ✅ RTS = Bun = Node | 126 |
| ❌ RTS diverge | 30 |
| 💥 RTS runtime error | 436 |
| 🛠️  **Falta corrigir** | **466** |
| ⚠️ Bun ≠ Node (skip) | 17 |
