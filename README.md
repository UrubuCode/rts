...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-39.2%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱] 39.2%   121/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **39.2%** (121/309) |
| ✅ RTS = Bun = Node | 121 |
| ❌ RTS diverge | 74 |
| 💥 RTS runtime error | 114 |
| 🛠️  **Falta corrigir** | **188** |
| ⚠️ Bun ≠ Node (skip) | 3 |
