...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-76.9%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 76.9%   286/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **76.9%** (286/372) |
| ✅ RTS = Bun = Node | 286 |
| ❌ RTS diverge | 27 |
