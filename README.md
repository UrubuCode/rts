...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 78.6%   243/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **78.6%** (243/309) |
| ✅ RTS = Bun = Node | 243 |
| ❌ RTS diverge | 24 |
| 💥 RTS runtime error | 42 |
| 🛠️  **Falta corrigir** | **66** |
| ⚠️ Bun ≠ Node (skip) | 3 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 312 |

_Atualizado: 2026-05-19 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
