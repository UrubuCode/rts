...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-86.8%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 86.8%   323/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **86.8%** (323/372) |
| ✅ RTS = Bun = Node | 323 |
| ❌ RTS diverge | 13 |
