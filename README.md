...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-75.4%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 75.4%   233/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **75.4%** (233/309) |
| ✅ RTS = Bun = Node | 233 |
| ❌ RTS diverge | 29 |
| 💥 RTS runtime error | 47 |
| 🛠️  **Falta corrigir** | **76** |
| ⚠️ Bun ≠ Node (skip) | 3 |
