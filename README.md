...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-99.7%25-brightgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰] 99.7%   370/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **99.7%** (370/371) |
| ✅ RTS = Bun = Node | 370 |
| ❌ RTS diverge | 1 |
| 💥 RTS runtime error | 0 |
| 🛠️  **Falta corrigir** | **1** |
