...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-26.4%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 26.4%   156/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **26.4%** (156/592) |
| ✅ RTS = Bun = Node | 156 |
| ❌ RTS diverge | 45 |
| 💥 RTS runtime error | 391 |
| 🛠️  **Falta corrigir** | **436** |
| ⚠️ Bun ≠ Node (skip) | 17 |
