...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.9%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.9%   253/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.9%** (253/309) |
| ✅ RTS = Bun = Node | 253 |
| ❌ RTS diverge | 20 |
