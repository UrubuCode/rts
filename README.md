...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-67.5%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 67.5%   208/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **67.5%** (208/308) |
| ✅ RTS = Bun = Node | 208 |
| ❌ RTS diverge | 33 |
