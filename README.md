...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.2%   251/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.2%** (251/309) |
| ✅ RTS = Bun = Node | 251 |
| ❌ RTS diverge | 21 |
...
_Atualizado: 2026-05-20 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
