...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.8%   249/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.8%** (249/308) |
| ✅ RTS = Bun = Node | 249 |
| ❌ RTS diverge | 20 |
