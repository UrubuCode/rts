...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-66.3%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱] 66.3%   205/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **66.3%** (205/309) |
| ✅ RTS = Bun = Node | 205 |
| ❌ RTS diverge | 35 |
| 💥 RTS runtime error | 69 |
| 🛠️  **Falta corrigir** | **104** |
| ⚠️ Bun ≠ Node (skip) | 3 |
