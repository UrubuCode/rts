...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.4%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.4%   299/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.4%** (299/372) |
| ✅ RTS = Bun = Node | 299 |
| ❌ RTS diverge | 17 |
