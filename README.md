...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-45.3%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 45.3%   268/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **45.3%** (268/592) |
| ✅ RTS = Bun = Node | 268 |
| ❌ RTS diverge | 136 |
| 💥 RTS runtime error | 188 |
| 🛠️  **Falta corrigir** | **324** |
| ⚠️ Bun ≠ Node (skip) | 17 |
