...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.3%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.3%   298/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.3%** (298/371) |
| ✅ RTS = Bun = Node | 298 |
| ❌ RTS diverge | 17 |
