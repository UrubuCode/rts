...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.6%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.6%   300/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.6%** (300/372) |
| ✅ RTS = Bun = Node | 300 |
| ❌ RTS diverge | 18 |
| 💥 RTS runtime error | 54 |
| 🛠️  **Falta corrigir** | **72** |
| ⚠️ Bun ≠ Node (skip) | 16 |
