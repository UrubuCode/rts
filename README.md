...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-87.9%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 87.9%   326/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **87.9%** (326/371) |
| ✅ RTS = Bun = Node | 326 |
| ❌ RTS diverge | 9 |
