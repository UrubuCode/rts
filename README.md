...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-86.3%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 86.3%   320/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **86.3%** (320/371) |
| ✅ RTS = Bun = Node | 320 |
| ❌ RTS diverge | 14 |
