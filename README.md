...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-43%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
| ✅ RTS = Bun = Node | 133 |
| ❌ RTS diverge | 68 |
| 💥 RTS runtime error | 108 |
| 🛠️  **Falta corrigir** | **176** |
| ⚠️ Bun ≠ Node (skip) | 3 |
