...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-88.4%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 88.4%   329/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **88.4%** (329/372) |
| ✅ RTS = Bun = Node | 329 |
| ❌ RTS diverge | 7 |
