...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-57.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱] 57.9%   179/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **57.9%** (179/309) |
| ✅ RTS = Bun = Node | 179 |
| ❌ RTS diverge | 45 |
| 💥 RTS runtime error | 85 |
| 🛠️  **Falta corrigir** | **130** |
| ⚠️ Bun ≠ Node (skip) | 3 |
