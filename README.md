...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-20.9%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 20.9%   124/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **20.9%** (124/592) |
| ✅ RTS = Bun = Node | 124 |
| ❌ RTS diverge | 30 |
| 💥 RTS runtime error | 438 |
