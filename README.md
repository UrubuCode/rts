...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-44.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 44.6%   264/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **44.6%** (264/592) |
| ✅ RTS = Bun = Node | 264 |
| ❌ RTS diverge | 133 |
| 💥 RTS runtime error | 195 |
| 🛠️  **Falta corrigir** | **328** |
| ⚠️ Bun ≠ Node (skip) | 17 |
