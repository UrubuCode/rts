...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.1%   301/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.1%** (301/371) |
| ✅ RTS = Bun = Node | 301 |
| ❌ RTS diverge | 19 |
...
_Atualizado: 2026-05-24 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
