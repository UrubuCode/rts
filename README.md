...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.8%   425/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **71.8%** (425/592) |
| ✅ RTS = Bun = Node | 425 |
| ❌ RTS diverge | 130 |
| 💥 RTS runtime error | 37 |
| 🛠️  **Falta corrigir** | **167** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-12 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
