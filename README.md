...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-98.4%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 98.4%   366/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **98.4%** (366/372) |
| ✅ RTS = Bun = Node | 366 |
| ❌ RTS diverge | 2 |
| 💥 RTS runtime error | 4 |
| 🛠️  **Falta corrigir** | **6** |
