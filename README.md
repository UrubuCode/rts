...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-43.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 43.6%   258/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **43.6%** (258/592) |
| ✅ RTS = Bun = Node | 258 |
| ❌ RTS diverge | 132 |
| 💥 RTS runtime error | 202 |
| 🛠️  **Falta corrigir** | **334** |
| ⚠️ Bun ≠ Node (skip) | 17 |
