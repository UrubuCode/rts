...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-73.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 73.1%   226/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **73.1%** (226/309) |
| ✅ RTS = Bun = Node | 226 |
| ❌ RTS diverge | 31 |
