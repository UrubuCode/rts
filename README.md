...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.5%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 82.5%   255/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **82.5%** (255/309) |
| ✅ RTS = Bun = Node | 255 |
| ❌ RTS diverge | 19 |
