...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.3%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 82.3%   306/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **82.3%** (306/372) |
| ✅ RTS = Bun = Node | 306 |
| ❌ RTS diverge | 17 |
