...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-68.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 68.9%   213/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **68.9%** (213/309) |
| ✅ RTS = Bun = Node | 213 |
| ❌ RTS diverge | 34 |
