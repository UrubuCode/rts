...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-52.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 52.9%   163/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **52.9%** (163/308) |
| ✅ RTS = Bun = Node | 163 |
| ❌ RTS diverge | 44 |
