...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-88.2%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 88.2%   328/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **88.2%** (328/372) |
| ✅ RTS = Bun = Node | 328 |
| ❌ RTS diverge | 8 |
