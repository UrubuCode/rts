...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-78.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 78.2%   290/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **78.2%** (290/371) |
| ✅ RTS = Bun = Node | 290 |
| ❌ RTS diverge | 24 |
| 💥 RTS runtime error | 57 |
| 🛠️  **Falta corrigir** | **81** |
| ⚠️ Bun ≠ Node (skip) | 17 |
