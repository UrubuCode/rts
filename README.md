...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-76.7%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 76.7%   237/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **76.7%** (237/309) |
| ✅ RTS = Bun = Node | 237 |
| ❌ RTS diverge | 28 |
