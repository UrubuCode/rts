...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-75.7%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 75.7%   234/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **75.7%** (234/309) |
| ✅ RTS = Bun = Node | 234 |
| ❌ RTS diverge | 30 |
