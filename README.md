...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-53.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 53.9%   319/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **53.9%** (319/592) |
| ✅ RTS = Bun = Node | 319 |
| ❌ RTS diverge | 112 |
| 💥 RTS runtime error | 161 |
| 🛠️  **Falta corrigir** | **273** |
| ⚠️ Bun ≠ Node (skip) | 17 |
