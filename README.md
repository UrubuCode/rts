...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-53.1%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 53.1%   164/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **53.1%** (164/309) |
| ✅ RTS = Bun = Node | 164 |
| ❌ RTS diverge | 44 |
