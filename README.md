...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰] 99.3%   2348/2364 measurements matching Blink
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 96%   96/100 fixtures passing
...
**DOM engine state** (`crates/rts-dom/PLAN.md` §0): **40/44 lots done**, 1 partial, pending: Q, U, V–Y. The paint ruler (pixels against Blink, `scripts/css_pintura.md`) needs a browser and runs locally; its last number is recorded there.
