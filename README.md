...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-98.7%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 98.7%   367/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **98.7%** (367/372) |
| ✅ RTS = Bun = Node | 367 |
| ❌ RTS diverge | 2 |
| 💥 RTS runtime error | 3 |
| 🛠️  **Falta corrigir** | **5** |
