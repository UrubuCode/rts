...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-25.8%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 25.8%   153/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **25.8%** (153/592) |
| ✅ RTS = Bun = Node | 153 |
| ❌ RTS diverge | 44 |
| 💥 RTS runtime error | 395 |
| 🛠️  **Falta corrigir** | **439** |
| ⚠️ Bun ≠ Node (skip) | 17 |
