...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-62.5%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱] 62.5%   193/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **62.5%** (193/309) |
| ✅ RTS = Bun = Node | 193 |
| ❌ RTS diverge | 44 |
| 💥 RTS runtime error | 72 |
| 🛠️  **Falta corrigir** | **116** |
| ⚠️ Bun ≠ Node (skip) | 3 |
