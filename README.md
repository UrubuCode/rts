...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-77.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 77.2%   287/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **77.2%** (287/372) |
| ✅ RTS = Bun = Node | 287 |
| ❌ RTS diverge | 26 |
