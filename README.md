...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-93.3%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 93.3%   346/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **93.3%** (346/371) |
| ✅ RTS = Bun = Node | 346 |
| ❌ RTS diverge | 6 |
