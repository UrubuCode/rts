...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-74.3%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 74.3%   440/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **74.3%** (440/592) |
| ✅ RTS = Bun = Node | 440 |
| ❌ RTS diverge | 60 |
| 💥 RTS runtime error | 92 |
| 🛠️  **Falta corrigir** | **152** |
| ⚠️ Bun ≠ Node (skip) | 17 |
