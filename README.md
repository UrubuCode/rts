...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-94.4%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 94.4%   351/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **94.4%** (351/372) |
| ✅ RTS = Bun = Node | 351 |
| ❌ RTS diverge | 4 |
