...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 82.6%   1251/1514 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **82.6%** (1251/1514) |
| ✅ RTS = Bun = Node | 1251 |
| ❌ RTS diverges | 202 |
...
_Updated: 2026-09-11 — [how to add a fixture](the spec removed 2026-08-03 (see git history))_
...
*Updated 2026-09-11 by CI (`dom-rulers`).*
<!-- CSS_DOM_STATS_END -->
...
End-to-end process time (includes startup/JIT compile), median of 20 runs after 3 warmups, GitHub Actions `windows-latest` — commit `57bcf09`.

| Bench | Bun | Node | Deno | RTS JIT | **RTS AOT** | AOT vs Bun | AOT vs Node |
|---|---|---|---|---|---|---:|---:|

_Updated: 2026-09-11 — run locally with `powershell -File bench/benchmark.ps1`_
