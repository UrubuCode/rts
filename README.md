...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-28.5%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 28.5%   169/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **28.5%** (169/592) |
| ✅ RTS = Bun = Node | 169 |
| ❌ RTS diverge | 47 |
| 💥 RTS runtime error | 376 |
| 🛠️  **Falta corrigir** | **423** |
| ⚠️ Bun ≠ Node (skip) | 17 |
