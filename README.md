...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-77.7%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 77.7%   240/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **77.7%** (240/309) |
| ✅ RTS = Bun = Node | 240 |
| ❌ RTS diverge | 25 |
