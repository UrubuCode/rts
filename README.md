...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 28.2%   87/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **28.2%** (87/309) |
| ✅ RTS = Bun = Node | 87 |
| ❌ RTS diverge | 90 |
| 💥 RTS runtime error | 132 |
| 🛠️  **Falta corrigir** | **222** |
| ⚠️ Bun ≠ Node (skip) | 3 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 312 |

_Atualizado: 2026-05-11 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
