...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-87.4%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 87.4%   325/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **87.4%** (325/372) |
| ✅ RTS = Bun = Node | 325 |
| ❌ RTS diverge | 12 |
