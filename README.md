...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-92.7%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 92.7%   344/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **92.7%** (344/371) |
| ✅ RTS = Bun = Node | 344 |
| ❌ RTS diverge | 6 |
| 💥 RTS runtime error | 21 |
| 🛠️  **Falta corrigir** | **27** |
| ⚠️ Bun ≠ Node (skip) | 17 |
