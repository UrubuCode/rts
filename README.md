...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-34.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 34.6%   107/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **34.6%** (107/309) |
| ✅ RTS = Bun = Node | 107 |
| ❌ RTS diverge | 79 |
| 💥 RTS runtime error | 123 |
| 🛠️  **Falta corrigir** | **202** |
| ⚠️ Bun ≠ Node (skip) | 3 |
