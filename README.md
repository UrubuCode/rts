...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.5%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.5%   303/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.5%** (303/372) |
| ✅ RTS = Bun = Node | 303 |
| ❌ RTS diverge | 20 |
