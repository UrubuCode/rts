...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-39.3%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱] 39.3%   232/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **39.3%** (232/591) |
| ✅ RTS = Bun = Node | 232 |
| ❌ RTS diverge | 103 |
| 💥 RTS runtime error | 256 |
| 🛠️  **Falta corrigir** | **359** |
| ⚠️ Bun ≠ Node (skip) | 18 |
