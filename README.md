...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-96.8%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 96.8%   360/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **96.8%** (360/372) |
| ✅ RTS = Bun = Node | 360 |
| ❌ RTS diverge | 3 |
| 💥 RTS runtime error | 9 |
| 🛠️  **Falta corrigir** | **12** |
