...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-33.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 33.6%   199/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **33.6%** (199/592) |
| ✅ RTS = Bun = Node | 199 |
| ❌ RTS diverge | 73 |
| 💥 RTS runtime error | 320 |
| 🛠️  **Falta corrigir** | **393** |
| ⚠️ Bun ≠ Node (skip) | 17 |
