...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-75.3%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 75.3%   280/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **75.3%** (280/372) |
| ✅ RTS = Bun = Node | 280 |
| ❌ RTS diverge | 23 |
