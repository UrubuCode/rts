...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-60.8%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱] 60.8%   188/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **60.8%** (188/309) |
| ✅ RTS = Bun = Node | 188 |
| ❌ RTS diverge | 49 |
