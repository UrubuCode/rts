...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-97.6%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 97.6%   363/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **97.6%** (363/372) |
| ✅ RTS = Bun = Node | 363 |
| ❌ RTS diverge | 3 |
| 💥 RTS runtime error | 6 |
| 🛠️  **Falta corrigir** | **9** |
