...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-74.9%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 74.9%   278/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **74.9%** (278/371) |
| ✅ RTS = Bun = Node | 278 |
| ❌ RTS diverge | 19 |
