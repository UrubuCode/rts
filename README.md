...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-75.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 75.8%   282/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **75.8%** (282/372) |
| ✅ RTS = Bun = Node | 282 |
| ❌ RTS diverge | 27 |
