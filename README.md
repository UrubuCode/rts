...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-51%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
| ✅ RTS = Bun = Node | 302 |
| ❌ RTS diverge | 128 |
| 💥 RTS runtime error | 162 |
| 🛠️  **Falta corrigir** | **290** |
| ⚠️ Bun ≠ Node (skip) | 17 |
