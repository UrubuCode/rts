...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-46.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 46.6%   276/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **46.6%** (276/592) |
| ✅ RTS = Bun = Node | 276 |
| ❌ RTS diverge | 146 |
| 💥 RTS runtime error | 170 |
| 🛠️  **Falta corrigir** | **316** |
| ⚠️ Bun ≠ Node (skip) | 17 |
