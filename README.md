...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-56.3%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 56.3%   333/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **56.3%** (333/591) |
| ✅ RTS = Bun = Node | 333 |
| ❌ RTS diverge | 111 |
| 💥 RTS runtime error | 147 |
| 🛠️  **Falta corrigir** | **258** |
| ⚠️ Bun ≠ Node (skip) | 18 |
