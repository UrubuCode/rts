...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-83.6%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 83.6%   310/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **83.6%** (310/371) |
| ✅ RTS = Bun = Node | 310 |
| ❌ RTS diverge | 17 |
