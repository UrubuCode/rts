...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-40.9%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱] 40.9%   242/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **40.9%** (242/591) |
| ✅ RTS = Bun = Node | 242 |
| ❌ RTS diverge | 126 |
| 💥 RTS runtime error | 223 |
| 🛠️  **Falta corrigir** | **349** |
| ⚠️ Bun ≠ Node (skip) | 18 |
