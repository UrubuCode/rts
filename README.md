...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.2%   247/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.2%** (247/308) |
| ✅ RTS = Bun = Node | 247 |
| ❌ RTS diverge | 22 |
