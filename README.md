...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-44.3%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 44.3%   137/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **44.3%** (137/309) |
| ✅ RTS = Bun = Node | 137 |
| ❌ RTS diverge | 67 |
| 💥 RTS runtime error | 105 |
