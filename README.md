...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-70.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 70.1%   216/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **70.1%** (216/308) |
| ✅ RTS = Bun = Node | 216 |
| ❌ RTS diverge | 36 |
