...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-75.5%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 75.5%   281/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **75.5%** (281/372) |
| ✅ RTS = Bun = Node | 281 |
| ❌ RTS diverge | 22 |
