...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 35.9%   212/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **35.9%** (212/591) |
| ✅ RTS = Bun = Node | 212 |
| ❌ RTS diverge | 87 |
| 💥 RTS runtime error | 292 |
| 🛠️  **Falta corrigir** | **379** |
| ⚠️ Bun ≠ Node (skip) | 18 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-28 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
