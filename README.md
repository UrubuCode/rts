...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-71.5%25-yellowgreen?style=flat-square)](the spec removed 2026-08-03 (see git history))
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.5%   1080/1511 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **71.5%** (1080/1511) |
| ✅ RTS = Bun = Node | 1080 |
| ❌ RTS diverges | 303 |
| 💥 RTS runtime error | 128 |
| 🛠️  **Left to fix** | **431** |
| ⚠️ Bun ≠ Node (skip) | 0 |
| 🚫 Rejected (RTS-only) | 0 |
| 📦 Total fixtures | 1512 |
