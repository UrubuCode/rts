...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-32.3%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 32.3%   191/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **32.3%** (191/592) |
| ✅ RTS = Bun = Node | 191 |
| ❌ RTS diverge | 58 |
| 💥 RTS runtime error | 343 |
| 🛠️  **Falta corrigir** | **401** |
| ⚠️ Bun ≠ Node (skip) | 17 |
