...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-74.5%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 74.5%   277/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **74.5%** (277/372) |
| ✅ RTS = Bun = Node | 277 |
| ❌ RTS diverge | 23 |
