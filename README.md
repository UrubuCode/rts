...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-25.7%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 25.7%   152/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **25.7%** (152/592) |
| ✅ RTS = Bun = Node | 152 |
| ❌ RTS diverge | 44 |
| 💥 RTS runtime error | 396 |
| 🛠️  **Falta corrigir** | **440** |
| ⚠️ Bun ≠ Node (skip) | 17 |
