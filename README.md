...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-52.4%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 52.4%   162/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **52.4%** (162/309) |
| ✅ RTS = Bun = Node | 162 |
| ❌ RTS diverge | 46 |
| 💥 RTS runtime error | 101 |
| 🛠️  **Falta corrigir** | **147** |
| ⚠️ Bun ≠ Node (skip) | 3 |
