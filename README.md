...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-90.9%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 90.9%   338/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **90.9%** (338/372) |
| ✅ RTS = Bun = Node | 338 |
| ❌ RTS diverge | 5 |
| 💥 RTS runtime error | 29 |
| 🛠️  **Falta corrigir** | **34** |
| ⚠️ Bun ≠ Node (skip) | 16 |
