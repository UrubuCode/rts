...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-85.4%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 85.4%   317/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **85.4%** (317/371) |
| ✅ RTS = Bun = Node | 317 |
| ❌ RTS diverge | 15 |
