...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-92.2%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 92.2%   343/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **92.2%** (343/372) |
| ✅ RTS = Bun = Node | 343 |
| ❌ RTS diverge | 6 |
| 💥 RTS runtime error | 23 |
| 🛠️  **Falta corrigir** | **29** |
| ⚠️ Bun ≠ Node (skip) | 16 |
