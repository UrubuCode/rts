...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-58.8%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱] 58.8%   181/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **58.8%** (181/308) |
| ✅ RTS = Bun = Node | 181 |
| ❌ RTS diverge | 48 |
