...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-79.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 79.8%   297/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **79.8%** (297/372) |
| ✅ RTS = Bun = Node | 297 |
| ❌ RTS diverge | 19 |
