...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-63.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱] 63.9%   378/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **63.9%** (378/592) |
| ✅ RTS = Bun = Node | 378 |
| ❌ RTS diverge | 84 |
| 💥 RTS runtime error | 130 |
| 🛠️  **Falta corrigir** | **214** |
| ⚠️ Bun ≠ Node (skip) | 17 |
