...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-67.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 67.9%   209/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **67.9%** (209/308) |
| ✅ RTS = Bun = Node | 209 |
| ❌ RTS diverge | 32 |
