...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-93.0%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 93.0%   346/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **93.0%** (346/372) |
| ✅ RTS = Bun = Node | 346 |
| ❌ RTS diverge | 6 |
| 💥 RTS runtime error | 20 |
| 🛠️  **Falta corrigir** | **26** |
| ⚠️ Bun ≠ Node (skip) | 16 |
