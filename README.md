...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-28.9%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 28.9%   171/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **28.9%** (171/592) |
| ✅ RTS = Bun = Node | 171 |
| ❌ RTS diverge | 49 |
| 💥 RTS runtime error | 372 |
| 🛠️  **Falta corrigir** | **421** |
| ⚠️ Bun ≠ Node (skip) | 17 |
