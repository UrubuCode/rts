...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-29.8%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 29.8%   92/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **29.8%** (92/309) |
| ✅ RTS = Bun = Node | 92 |
| ❌ RTS diverge | 87 |
| 💥 RTS runtime error | 130 |
| 🛠️  **Falta corrigir** | **217** |
| ⚠️ Bun ≠ Node (skip) | 3 |
