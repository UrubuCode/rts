...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-74.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 74.2%   439/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **74.2%** (439/592) |
| ✅ RTS = Bun = Node | 439 |
| ❌ RTS diverge | 59 |
| 💥 RTS runtime error | 94 |
| 🛠️  **Falta corrigir** | **153** |
| ⚠️ Bun ≠ Node (skip) | 17 |
