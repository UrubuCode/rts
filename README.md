...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-74.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 74.8%   443/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **74.8%** (443/592) |
| ✅ RTS = Bun = Node | 443 |
| ❌ RTS diverge | 62 |
| 💥 RTS runtime error | 87 |
| 🛠️  **Falta corrigir** | **149** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-07-04 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
