...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-68.6%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 68.6%   212/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **68.6%** (212/309) |
| ✅ RTS = Bun = Node | 212 |
| ❌ RTS diverge | 34 |
