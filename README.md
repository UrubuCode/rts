...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰] 99.3%   2368/2384 measurements matching Blink
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 96%   97/101 fixtures passing
[▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱] 39.7%   194/489 WPT reftests (css-flexbox) rendering test == reference
```
...
**DOM engine state** (`crates/rts-dom/PLAN.md` §0): **41/45 lots done**, 1 partial, pending: Q, U, V–Y. The paint ruler (pixels against Blink, `scripts/css_pintura.md`) needs a browser and runs locally; its last number is recorded there.
