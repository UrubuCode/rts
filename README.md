...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-44.1%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 44.1%   261/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **44.1%** (261/592) |
| ✅ RTS = Bun = Node | 261 |
| ❌ RTS diverge | 132 |
| 💥 RTS runtime error | 199 |
| 🛠️  **Falta corrigir** | **331** |
| ⚠️ Bun ≠ Node (skip) | 17 |
