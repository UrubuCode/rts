...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-42.7%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 42.7%   132/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **42.7%** (132/309) |
| ✅ RTS = Bun = Node | 132 |
| ❌ RTS diverge | 68 |
| 💥 RTS runtime error | 109 |
| 🛠️  **Falta corrigir** | **177** |
| ⚠️ Bun ≠ Node (skip) | 3 |
