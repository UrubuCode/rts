...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-89.2%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 89.2%   332/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **89.2%** (332/372) |
| ✅ RTS = Bun = Node | 332 |
| ❌ RTS diverge | 4 |
