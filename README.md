...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-36.4%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 36.4%   112/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **36.4%** (112/308) |
| ✅ RTS = Bun = Node | 112 |
| ❌ RTS diverge | 75 |
