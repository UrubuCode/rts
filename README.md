...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 72.3%   428/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **72.3%** (428/592) |
| ✅ RTS = Bun = Node | 428 |
| ❌ RTS diverge | 127 |
| 💥 RTS runtime error | 37 |
| 🛠️  **Falta corrigir** | **164** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-09 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
