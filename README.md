...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-43.8%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 43.8%   259/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **43.8%** (259/592) |
| ✅ RTS = Bun = Node | 259 |
| ❌ RTS diverge | 132 |
| 💥 RTS runtime error | 201 |
| 🛠️  **Falta corrigir** | **333** |
| ⚠️ Bun ≠ Node (skip) | 17 |
