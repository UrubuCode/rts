...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-54.9%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 54.9%   169/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **54.9%** (169/308) |
| ✅ RTS = Bun = Node | 169 |
| ❌ RTS diverge | 45 |
