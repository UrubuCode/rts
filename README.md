...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-25.5%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 25.5%   151/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **25.5%** (151/592) |
| ✅ RTS = Bun = Node | 151 |
| ❌ RTS diverge | 44 |
| 💥 RTS runtime error | 397 |
| 🛠️  **Falta corrigir** | **441** |
| ⚠️ Bun ≠ Node (skip) | 17 |
