...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-34.2%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 34.2%   202/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **34.2%** (202/591) |
| ✅ RTS = Bun = Node | 202 |
| ❌ RTS diverge | 75 |
| 💥 RTS runtime error | 314 |
| 🛠️  **Falta corrigir** | **389** |
| ⚠️ Bun ≠ Node (skip) | 18 |
