...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-51.7%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 51.7%   306/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **51.7%** (306/592) |
| ✅ RTS = Bun = Node | 306 |
| ❌ RTS diverge | 123 |
| 💥 RTS runtime error | 163 |
| 🛠️  **Falta corrigir** | **286** |
| ⚠️ Bun ≠ Node (skip) | 17 |
