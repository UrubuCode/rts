...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-30.5%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 30.5%   180/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **30.5%** (180/591) |
| ✅ RTS = Bun = Node | 180 |
| ❌ RTS diverge | 51 |
| 💥 RTS runtime error | 360 |
| 🛠️  **Falta corrigir** | **411** |
| ⚠️ Bun ≠ Node (skip) | 18 |
