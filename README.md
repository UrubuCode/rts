...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-99.2%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 99.2%   369/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **99.2%** (369/372) |
| ✅ RTS = Bun = Node | 369 |
| ❌ RTS diverge | 1 |
| 💥 RTS runtime error | 2 |
| 🛠️  **Falta corrigir** | **3** |
