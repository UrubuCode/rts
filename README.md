...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-93.8%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 93.8%   349/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **93.8%** (349/372) |
| ✅ RTS = Bun = Node | 349 |
| ❌ RTS diverge | 6 |
