...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-34.3%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 34.3%   106/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **34.3%** (106/309) |
| ✅ RTS = Bun = Node | 106 |
| ❌ RTS diverge | 80 |
| 💥 RTS runtime error | 123 |
| 🛠️  **Falta corrigir** | **203** |
| ⚠️ Bun ≠ Node (skip) | 3 |
