...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-29.9%25-red?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 29.9%   92/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **29.9%** (92/308) |
| ✅ RTS = Bun = Node | 92 |
| ❌ RTS diverge | 86 |
| 💥 RTS runtime error | 130 |
| 🛠️  **Falta corrigir** | **216** |
| ⚠️ Bun ≠ Node (skip) | 4 |
