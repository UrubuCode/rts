...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-86.5%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 86.5%   321/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **86.5%** (321/371) |
| ✅ RTS = Bun = Node | 321 |
| ❌ RTS diverge | 14 |
