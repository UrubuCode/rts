...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-75.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 75.1%   232/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **75.1%** (232/309) |
| ✅ RTS = Bun = Node | 232 |
| ❌ RTS diverge | 28 |
| 💥 RTS runtime error | 49 |
| 🛠️  **Falta corrigir** | **77** |
| ⚠️ Bun ≠ Node (skip) | 3 |
