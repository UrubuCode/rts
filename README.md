...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-94.3%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 94.3%   350/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **94.3%** (350/371) |
| ✅ RTS = Bun = Node | 350 |
| ❌ RTS diverge | 4 |
| 💥 RTS runtime error | 17 |
| 🛠️  **Falta corrigir** | **21** |
| ⚠️ Bun ≠ Node (skip) | 17 |
