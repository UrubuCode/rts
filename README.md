...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-78.3%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 78.3%   242/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **78.3%** (242/309) |
| ✅ RTS = Bun = Node | 242 |
| ❌ RTS diverge | 24 |
