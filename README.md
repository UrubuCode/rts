...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-72.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 72.8%   270/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **72.8%** (270/371) |
| ✅ RTS = Bun = Node | 270 |
| ❌ RTS diverge | 30 |
| 💥 RTS runtime error | 71 |
| 🛠️  **Falta corrigir** | **101** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 388 |

_Atualizado: 2026-05-22 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
