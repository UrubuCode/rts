...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-43.9%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱] 43.9%   260/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **43.9%** (260/592) |
| ✅ RTS = Bun = Node | 260 |
| ❌ RTS diverge | 131 |
| 💥 RTS runtime error | 201 |
| 🛠️  **Falta corrigir** | **332** |
| ⚠️ Bun ≠ Node (skip) | 17 |
