...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-53.2%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 53.2%   315/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **53.2%** (315/592) |
| ✅ RTS = Bun = Node | 315 |
| ❌ RTS diverge | 116 |
| 💥 RTS runtime error | 161 |
| 🛠️  **Falta corrigir** | **277** |
| ⚠️ Bun ≠ Node (skip) | 17 |
