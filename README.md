...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-71.8%25-yellowgreen?style=flat-square)](the spec removed 2026-08-03 (see git history))
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.8%   1085/1511 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **71.8%** (1085/1511) |
| ✅ RTS = Bun = Node | 1085 |
| ❌ RTS diverges | 299 |
