...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.7%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 82.7%   307/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **82.7%** (307/371) |
| ✅ RTS = Bun = Node | 307 |
| ❌ RTS diverge | 19 |
| 💥 RTS runtime error | 45 |
| 🛠️  **Falta corrigir** | **64** |
| ⚠️ Bun ≠ Node (skip) | 17 |
