...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-79.6%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 79.6%   296/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **79.6%** (296/372) |
| ✅ RTS = Bun = Node | 296 |
| ❌ RTS diverge | 20 |
