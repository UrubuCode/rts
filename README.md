...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-37.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱] 37.6%   222/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **37.6%** (222/591) |
| ✅ RTS = Bun = Node | 222 |
| ❌ RTS diverge | 86 |
| 💥 RTS runtime error | 283 |
| 🛠️  **Falta corrigir** | **369** |
| ⚠️ Bun ≠ Node (skip) | 18 |
