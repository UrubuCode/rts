...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-49%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
| ✅ RTS = Bun = Node | 290 |
| ❌ RTS diverge | 133 |
| 💥 RTS runtime error | 169 |
| 🛠️  **Falta corrigir** | **302** |
| ⚠️ Bun ≠ Node (skip) | 17 |
