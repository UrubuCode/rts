...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-38%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
| ✅ RTS = Bun = Node | 117 |
| ❌ RTS diverge | 74 |
| 💥 RTS runtime error | 117 |
| 🛠️  **Falta corrigir** | **191** |
| ⚠️ Bun ≠ Node (skip) | 4 |
