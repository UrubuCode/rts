...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-83.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 83.8%   311/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **83.8%** (311/371) |
| ✅ RTS = Bun = Node | 311 |
| ❌ RTS diverge | 16 |
