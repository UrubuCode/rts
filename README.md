...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-97.8%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 97.8%   364/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **97.8%** (364/372) |
| ✅ RTS = Bun = Node | 364 |
| ❌ RTS diverge | 3 |
| 💥 RTS runtime error | 5 |
| 🛠️  **Falta corrigir** | **8** |
