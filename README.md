...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-71.4%25-yellowgreen?style=flat-square)](the spec removed 2026-08-03 (see git history))
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.4%   1078/1510 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **71.4%** (1078/1510) |
| ✅ RTS = Bun = Node | 1078 |
| ❌ RTS diverges | 303 |
| 💥 RTS runtime error | 129 |
| 🛠️  **Left to fix** | **432** |
| ⚠️ Bun ≠ Node (skip) | 1 |
| 🚫 Rejected (RTS-only) | 0 |
| 📦 Total fixtures | 1512 |
