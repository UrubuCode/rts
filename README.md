...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-55.1%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 55.1%   326/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **55.1%** (326/592) |
| ✅ RTS = Bun = Node | 326 |
| ❌ RTS diverge | 111 |
| 💥 RTS runtime error | 155 |
| 🛠️  **Falta corrigir** | **266** |
| ⚠️ Bun ≠ Node (skip) | 17 |
