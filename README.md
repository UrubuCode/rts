...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-78.4%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 78.4%   291/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **78.4%** (291/371) |
| ✅ RTS = Bun = Node | 291 |
| ❌ RTS diverge | 23 |
