...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-73.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 73.8%   228/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **73.8%** (228/309) |
| ✅ RTS = Bun = Node | 228 |
| ❌ RTS diverge | 31 |
