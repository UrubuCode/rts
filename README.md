...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-71.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.2%   220/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **71.2%** (220/309) |
| ✅ RTS = Bun = Node | 220 |
| ❌ RTS diverge | 33 |
