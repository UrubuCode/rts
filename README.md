...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-98.9%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 98.9%   368/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **98.9%** (368/372) |
| ✅ RTS = Bun = Node | 368 |
| ❌ RTS diverge | 1 |
| 💥 RTS runtime error | 3 |
| 🛠️  **Falta corrigir** | **4** |
