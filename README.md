...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-91.1%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 91.1%   339/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **91.1%** (339/372) |
| ✅ RTS = Bun = Node | 339 |
| ❌ RTS diverge | 6 |
| 💥 RTS runtime error | 27 |
| 🛠️  **Falta corrigir** | **33** |
| ⚠️ Bun ≠ Node (skip) | 16 |
