...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.2%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 82.2%   305/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **82.2%** (305/371) |
| ✅ RTS = Bun = Node | 305 |
| ❌ RTS diverge | 18 |
