...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-37.3%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 37.3%   221/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **37.3%** (221/592) |
| ✅ RTS = Bun = Node | 221 |
| ❌ RTS diverge | 85 |
| 💥 RTS runtime error | 286 |
| 🛠️  **Falta corrigir** | **371** |
| ⚠️ Bun ≠ Node (skip) | 17 |
