...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-85.7%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 85.7%   318/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **85.7%** (318/371) |
| ✅ RTS = Bun = Node | 318 |
| ❌ RTS diverge | 16 |
