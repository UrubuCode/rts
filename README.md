...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-55.7%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 55.7%   172/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **55.7%** (172/309) |
| ✅ RTS = Bun = Node | 172 |
| ❌ RTS diverge | 50 |
| 💥 RTS runtime error | 87 |
| 🛠️  **Falta corrigir** | **137** |
| ⚠️ Bun ≠ Node (skip) | 3 |
