...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-93.5%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
<<<<<<< HEAD
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 93.5%   348/372 fixtures passam
=======
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 93.3%   347/372 fixtures passam
>>>>>>> origin/main
```
...
|---|---|
<<<<<<< HEAD
| **Paridade** | **93.5%** (348/372) |
| ✅ RTS = Bun = Node | 348 |
=======
| **Paridade** | **93.3%** (347/372) |
| ✅ RTS = Bun = Node | 347 |
>>>>>>> origin/main
| ❌ RTS diverge | 6 |
| 💥 RTS runtime error | 19 |
| 🛠️  **Falta corrigir** | **25** |
| ⚠️ Bun ≠ Node (skip) | 16 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 388 |

_Atualizado: 2026-06-04 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
