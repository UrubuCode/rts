...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-54.4%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 54.4%   168/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **54.4%** (168/309) |
| ✅ RTS = Bun = Node | 168 |
| ❌ RTS diverge | 45 |
