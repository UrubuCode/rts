...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-97.0%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱] 97.0%   361/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **97.0%** (361/372) |
| ✅ RTS = Bun = Node | 361 |
| ❌ RTS diverge | 4 |
| 💥 RTS runtime error | 7 |
| 🛠️  **Falta corrigir** | **11** |
