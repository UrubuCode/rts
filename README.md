...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-33.8%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 33.8%   200/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **33.8%** (200/592) |
| ✅ RTS = Bun = Node | 200 |
| ❌ RTS diverge | 73 |
| 💥 RTS runtime error | 319 |
| 🛠️  **Falta corrigir** | **392** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-26 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
