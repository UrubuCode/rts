...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-76.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 76.8%   285/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **76.8%** (285/371) |
| ✅ RTS = Bun = Node | 285 |
| ❌ RTS diverge | 25 |
