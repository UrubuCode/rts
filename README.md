...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-53.5%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱] 53.5%   317/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **53.5%** (317/592) |
| ✅ RTS = Bun = Node | 317 |
| ❌ RTS diverge | 116 |
| 💥 RTS runtime error | 159 |
| 🛠️  **Falta corrigir** | **275** |
| ⚠️ Bun ≠ Node (skip) | 17 |
