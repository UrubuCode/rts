...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-50.2%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 50.2%   155/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **50.2%** (155/309) |
| ✅ RTS = Bun = Node | 155 |
| ❌ RTS diverge | 53 |
