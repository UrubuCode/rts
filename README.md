...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-82.8%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 82.8%   255/308 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **82.8%** (255/308) |
| ✅ RTS = Bun = Node | 255 |
| ❌ RTS diverge | 18 |
