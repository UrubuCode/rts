...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 84.2%   1275/1514 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **84.2%** (1275/1514) |
| ✅ RTS = Bun = Node | 1275 |
| ❌ RTS diverges | 178 |
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰] 100%   3424/3424 measurements matching Blink
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰] 100%   148/148 fixtures passing
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 70.9%   617/870 WPT reftests (css-flexbox) rendering test == reference
```
...
End-to-end process time (includes startup/JIT compile), median of 20 runs after 3 warmups, GitHub Actions `windows-latest` — commit `206cd06`.
