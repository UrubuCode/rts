...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-84.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 84.1%   313/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **84.1%** (313/372) |
| ✅ RTS = Bun = Node | 313 |
| ❌ RTS diverge | 16 |
