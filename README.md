...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-34.1%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 34.1%   202/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **34.1%** (202/592) |
| ✅ RTS = Bun = Node | 202 |
| ❌ RTS diverge | 75 |
| 💥 RTS runtime error | 315 |
| 🛠️  **Falta corrigir** | **390** |
| ⚠️ Bun ≠ Node (skip) | 17 |
