...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.1%   298/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.1%** (298/372) |
| ✅ RTS = Bun = Node | 298 |
| ❌ RTS diverge | 18 |
