...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-80.9%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 80.9%   301/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **80.9%** (301/372) |
| ✅ RTS = Bun = Node | 301 |
| ❌ RTS diverge | 15 |
