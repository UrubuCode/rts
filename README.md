...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-38.9%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱] 38.9%   230/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **38.9%** (230/592) |
| ✅ RTS = Bun = Node | 230 |
| ❌ RTS diverge | 89 |
