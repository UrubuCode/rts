...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱] 71.1%   421/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **71.1%** (421/592) |
| ✅ RTS = Bun = Node | 421 |
| ❌ RTS diverge | 136 |
| 💥 RTS runtime error | 35 |
| 🛠️  **Falta corrigir** | **171** |
| ⚠️ Bun ≠ Node (skip) | 17 |
| 🚫 Rejeitados (RTS-only) | 0 |
| 📦 Total fixtures | 609 |

_Atualizado: 2026-06-14 — [como adicionar fixture](docs/specs/cross-runtime-testing.md)_
