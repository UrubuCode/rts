...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-51.1%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 51.1%   158/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **51.1%** (158/309) |
| ✅ RTS = Bun = Node | 158 |
| ❌ RTS diverge | 50 |
| 💥 RTS runtime error | 101 |
| 🛠️  **Falta corrigir** | **151** |
| ⚠️ Bun ≠ Node (skip) | 3 |
