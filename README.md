...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-76.1%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 76.1%   283/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **76.1%** (283/372) |
| ✅ RTS = Bun = Node | 283 |
| ❌ RTS diverge | 22 |
