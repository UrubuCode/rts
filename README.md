...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-84.1%25-yellowgreen?style=flat-square)](the spec removed 2026-08-03 (see git history))
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱] 84.1%   1274/1514 fixtures passing
```

| Metric | Value |
|---|---|
| **Parity** | **84.1%** (1274/1514) |
| ✅ RTS = Bun = Node | 1274 |
| ❌ RTS diverges | 180 |
...
*Updated 2026-09-21 by CI (`dom-rulers`).*
<!-- CSS_DOM_STATS_END -->
