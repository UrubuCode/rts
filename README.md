...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-79.9%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 79.9%   247/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **79.9%** (247/309) |
| ✅ RTS = Bun = Node | 247 |
| ❌ RTS diverge | 23 |
