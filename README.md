...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-89.5%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 89.5%   333/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **89.5%** (333/372) |
| ✅ RTS = Bun = Node | 333 |
| ❌ RTS diverge | 6 |
