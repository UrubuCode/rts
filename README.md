...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-35.8%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱] 35.8%   212/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **35.8%** (212/592) |
| ✅ RTS = Bun = Node | 212 |
| ❌ RTS diverge | 82 |
| 💥 RTS runtime error | 298 |
| 🛠️  **Falta corrigir** | **380** |
| ⚠️ Bun ≠ Node (skip) | 17 |
