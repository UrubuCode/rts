...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-66.7%25-yellow?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱] 66.7%   206/309 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **66.7%** (206/309) |
| ✅ RTS = Bun = Node | 206 |
| ❌ RTS diverge | 36 |
