...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-47.6%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱] 47.6%   282/592 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **47.6%** (282/592) |
| ✅ RTS = Bun = Node | 282 |
| ❌ RTS diverge | 140 |
| 💥 RTS runtime error | 170 |
| 🛠️  **Falta corrigir** | **310** |
| ⚠️ Bun ≠ Node (skip) | 17 |
