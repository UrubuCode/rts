...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-40%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
| ✅ RTS = Bun = Node | 237 |
| ❌ RTS diverge | 116 |
| 💥 RTS runtime error | 239 |
| 🛠️  **Falta corrigir** | **355** |
| ⚠️ Bun ≠ Node (skip) | 17 |
