...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-73.9%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱] 73.9%   275/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **73.9%** (275/372) |
| ✅ RTS = Bun = Node | 275 |
| ❌ RTS diverge | 26 |
