...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-32.5%25-orange?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱] 32.5%   192/591 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **32.5%** (192/591) |
| ✅ RTS = Bun = Node | 192 |
| ❌ RTS diverge | 59 |
| 💥 RTS runtime error | 340 |
| 🛠️  **Falta corrigir** | **399** |
| ⚠️ Bun ≠ Node (skip) | 18 |
