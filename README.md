...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-81.4%25-yellowgreen?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱] 81.4%   302/371 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **81.4%** (302/371) |
| ✅ RTS = Bun = Node | 302 |
| ❌ RTS diverge | 19 |
