...
[![Bun/Node parity](https://img.shields.io/badge/Bun%2FNode%20parity-89.8%25-green?style=flat-square)](docs/specs/cross-runtime-testing.md)
...
```
[▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▱▱] 89.8%   334/372 fixtures passam
```

| Métrica | Valor |
|---|---|
| **Paridade** | **89.8%** (334/372) |
| ✅ RTS = Bun = Node | 334 |
| ❌ RTS diverge | 6 |
