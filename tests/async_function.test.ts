...
// `promise.wait` (drain sincrono da superficie antiga) virou `await` de topo.
const p1 = getAnswer();
print("getAnswer.wait=" + (await p1));
...
const p3 = makeNumber();
print("makeNumber.wait=" + (await p3));
